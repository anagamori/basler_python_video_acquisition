...
start_frame = int(2.2*fps)
end_frame = int(3.0*fps)
frame_str = '_' + str(start_frame) + '_' + str(end_frame)
idx = range(start_frame,end_frame)

filename = "C:\\Users\\anaga\\OneDrive\\Desktop\\Research\\Presentation\\U19\\All-hands\\Videos\\CFL18_04112023_saline_1_15-39-03_cam2"
infile = open(filename, "rb" )
data = cPickle.load(infile)
# cannot use quality = 10 if you want to play it on powerpoint 
writer = get_writer(filename + frame_str +ext,fps = fps_new)
